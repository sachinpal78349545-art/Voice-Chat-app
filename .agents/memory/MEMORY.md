...
- [Realtime conversation identity](realtime-conversation-identity.md) — render list identity and presence from live participant profiles, not stale conversation snapshots or generated demo values.
